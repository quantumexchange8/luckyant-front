                        ...
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded" >
                                ...
                                <div class="uk-card-body toggle-text"  id="sustain"> 
                                    ...
                                    <p class="uk-text-justify">By using our CopyTrading services, you agree to the terms of our portfolio management service. </p>
                                    ...
                                    <p class=" uk-text-justify hidden">CopyTrading does not constitute the same as providing investment advice. Your 	investments could increase or decrease in value.</p>
                                    <p class="hidden uk-text-justify">CopyTrading allows you to copy other traders whose profiles are public, with some restrictions. More information on how to set up your strategy will be accessible once your account is qualified for CopyTrading.</p>
                        ...
                        <div class="in-stretch" >
                            <article class="uk-card uk-card-default uk-border-rounded">
                                ...
                                <div class="uk-card-body toggle-text" id="terms">
                                    ...
                                    <p class=" uk-text-justify hidden">When using our CopyTrading services, We will provide you with investment management 	services. This means that transactions will automatically open in your Account on your 	behalf with respect to the amount copying such a portfolio once initiated by the copied account, portfolio, and/or strategy. The opening of such transactions shall not require any 	prior consultation, consent, or approval.
                                    </p>
                                    <p class="hidden uk-text-justify"> You are permitted to store, display, analyse, modify, and print the information made 	available through the Trading Platform. However, a Client is not permitted to publish, 	transmit, or otherwise reproduce that information, in whole or in part, in any format to 	any third party without or consent. Therefore, Clients may not alter, obscure, or remove 	any copyright, trademark, or any other notices that are provided on the Trading platform 	or on our website.
                                    </p>
                                    <p class="hidden uk-text-justify">Trading with Lucky Ant Trading by following the trades/strategy of other traders is 	associated with a high range of risks. Such risks may include the risk of copying the 	trading decisions of inexperienced/unskilled traders or traders whose ultimate goal or 	financial status may vary from yours. Before making the decision to copy a trader/strategy, 	you should consider your financial situation and conduct your personal assessment of the 	specific trader.
                                    </p>
                                    <p class="hidden uk-text-justify">Past performance of Lucky Ant Trading community members, even of top-performing 	traders, 	is not indicative of future performance. Lucky Ant Trading does not guarantee 	that your account’s performance, including any potential profits or losses, is likely to be similar to the trades/strategies you are copying. We are also unable to guarantee that the 	risk score of a trader will mirror the risk of their future performance.
                                    </p>
                        ...
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded">
                                ...
                                <div class="uk-card-body toggle-text"  id="fees">
                                    ...
                                    <p class="uk-text-justify">The Strategy provider may impose any of the following fee structures (or a combination of any of them) :
                                    </p>
                                    <p class="hidden  uk-text-justify">
                                     <ul  class="nested-list hidden">
                                        <li>Management Fee is a periodic payment that the follower pays to a strategy provider 	regardless of the strategy performance and is set by a strategy provider as an annual 	percentage (maximum 10%) of the follower’s equity or not.</li>
                                        <li>Performance Fee is the percentage (maximum 40%) of the total net profit generated by a 	strategy on the Copy Trading Account and is paid at the first of each month, so a follower 	never pays twice for the same performance and/or underperformance.</li>
                                        <li>If you wish to learn more information about the fees and charges associated with copytrading you can access through our website, where you can find an in-depth analysis 	alongside examples of fees calculation.</li>
                                        <li>When you place a copy trade, you agree and acknowledge that Lucky Ant Trading is authorised to proceed in deducting from your Account and pay the Strategy Provider any payable fees like management fees, performance fees and/or volume fees.</li>
                                        <li>Any payable fees are visible in the strategy settings under your Account profile.The Client 	should consider such fees before making a decision to invest in a strategy, as such fees 	may affect the performance of your CopyTrading Accoun</li>
                                    </ul>
                                    </p>
                                </div>
                                <div class="uk-card-footer uk-clearfix">
                    ...
                    <aside class="uk-margin-medium-bottom">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded">        
                            ...
                            <ul class="uk-list widget-categories">
                                ...
                                <li><a href="{{route('copytradepolicy')}}">Copy Trading Terms and Conditions</a></li>
                            </ul>
                        </div>
                    </aside>
