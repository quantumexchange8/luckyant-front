        ...
        <div class="uk-width-1-1@m">
            <div class="uk-card uk-card-default uk-card-body uk-margin-bottom">
                ...
                <div class="uk-width-1-1@m">
                    ...
                    <p class="uk-text-meta">The conditions referred to in this paragraph are as follows : </p>
                        <ul class="uk-text-meta">
                            ...
                            <li>A Force Majeure Event must not have occurred</li>
                            <li>When you instruct us to open a Contract you must not have committed a material
                                default</li>
                            <li>The telephone or internet conversation in which you instruct us to open or close
                                ...
                                executed by us</li>
                            <li>When you instruct us to open any Contract, the opening of the Contract must not
                                result in your exceeding any credit or other limit placed upon your dealing and</li>
                            <li> The instruction must be given to us during normal trading hours for the
                ...
                <div class="uk-width-1-1@m">
                    ...
                    <ul>
                        <li class="uk-text-justify uk-text-meta">You acknowledge that the internet is, due to unpredictable traffic congestion and
                            other reasons, an inherently unreliable medium of communication and that such
                            unreliability is beyond our control.</li>
                        <li class="uk-text-justify uk-text-meta">Trading on the internet is not instantaneous and several seconds may elapse
                            ...
                            PC.</li>
                        <li class="uk-text-justify uk-text-meta">We reserve the right not to execute an order by you until it has been received by us.</li>
                        <li class="uk-text-justify uk-text-meta">We shall not be liable for any loss, expense, cost or liability (including consequential
                        ...
                        <li class="uk-text-justify uk-text-meta">You will solely be responsible for all orders and for the accuracy of all information
                            sent via the internet using your name or personal identification number.</li>
                        <li class="uk-text-justify uk-text-meta">You further acknowledge and agree that there are risks of misunderstandings or
                            errors in any communication and that such risks shall be absolutely borne by you</li>
                        <li class="uk-text-justify uk-text-meta">You acknowledge and agree that it shall not usually be possible to cancel an
                                instruction after it has been given</li>
                        <li class="uk-text-justify uk-text-meta">The time shown by our electronic logging system and the information contained on
                ...
                <div class="uk-width-1-1@m">
                    ...
                    <ul>
                        <li class="uk-text-justify uk-text-meta">Any act, event or occurrence (including without limitation any strike, riot or civil
                        ...
                        <li class="uk-text-justify uk-text-meta">The suspension or closure of any market or the abandonment or failure of any event
                    ...
                    <ul>
                        <li class="uk-text-justify uk-text-meta">Close any or all of your open Contracts at such closing level as we reasonably
                            believe to be appropriate</li>
                        <li class="uk-text-justify uk-text-meta">Suspend or modify the application of all or any of the terms of this agreement to the
                        ...
                        <li class="uk-text-justify uk-text-meta">Alter the last time for trading for a particular Contract</li>
