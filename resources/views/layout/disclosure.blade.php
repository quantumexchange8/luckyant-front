               ...
               <h3> <i class="fas fa-check-circle fa-sm"></i> Shares</h3>
                ...
                <h4>Dealing in shares may involve the following specific risks :</h4>
                  <ol style=" list-style-type: lower-alpha">
                    <li class="uk-text-justify uk-text-meta"> Company risk: a share purchaser does not lend funds to the company, but makes a capital contribution and, as such takes an ownership interest in the corporation. It is difficult to forecast the precise yield on such an investment.An extreme case would be if the company went bankrupt, thereby wiping out the total sums invested.</li>
                    <li  class="uk-text-justify uk-text-meta"> Price risk: share prices may undergo unforeseeable price fluctuations causing risks of loss. Price increases and decreases in short-medium and long-term alternate without it being possible to determine the duration of those cycles.General market must be distinguished from the specific risk attached to the company itself. Both risks, jointly or in aggregate, influence evolution of share prices.</li>
