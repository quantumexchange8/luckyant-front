...
return [
    ...
    'mt5_mobile_mobile'=>'Trade on the go with a comprehensive suite of MT5 mobile trading apps, compatible with iPhone, iPad, and Android devices.',
    ...
    'stock_caption5'=>'CFDs are also a form of leveraged product, and margin requirements mean you only need to deposit a fraction of the total trade value as margin to open a CFD position. In stock trading, you typically need to buy the entire required shares. Leverage comes with potential risks, so understanding the risks of leverage is crucial before trading.',
    'stock_caption6'=>'Commodities Trading Contracts for Difference (CFDs) in commodities is an ideal choice for diversifying portfolios and hedging risks. We offer a broad portfolio of financial products, combined with real-time technology and commodity prices, to help you gain an edge. Choosing to trade commodity CFDs provides you with global commodity prices, enjoying advantages such as high-speed execution, low slippage, deep liquidity, and narrow spreads.',
    'stock_caption7'=>'As a regulated brokerage service provider, we support you in trading commodity CFDs, covering various global commodities such as gold (XAU), silver (XAG), and crude oil (CL, WTI). Meanwhile, we offer diverse asset categories and comprehensive risk management tools, enabling you to navigate the markets with ease.',
    ...
    'contact_caption'=>'Thank you for choosing to get in touch with us. Please use the registration information form below to provide your details, or you can contact us via email at support@luckyantfxasia.com. This will help us better understand your needs and provide you with professional assistance. Your information will be kept confidential and used to handle your inquiries.',
    'name'=>'Name',
